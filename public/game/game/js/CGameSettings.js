function CGameSettings(oJsonData) {
    ...
    this._initSimpleOdd = function () {
        //STORE ODD INFOS
        var aOddWin = _oJsonData.odd_win_bet.slice(0, NUM_HOR);
        var aOddPlace = _oJsonData.odd_place_bet.slice(0, NUM_HOR);
        var aOddShow = _oJsonData.odd_show_bet.slice(0, NUM_HOR);
