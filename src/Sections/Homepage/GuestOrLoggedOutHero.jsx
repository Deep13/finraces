...
const GuestOrLoggedOutHero = () => {
  const { setCreateRace, profileImage, setSelectedStock, setShowLoginForm } =
      ...
      <div className="max-w-[1400px] rounded-lg mb-[3.3rem] flex justify-between flex-wrap items-start">
        ...
        {lastRaceId ? (
          ...
          >
            <div className="flex flex-col gap-[8px] cursor-pointer ">
              <p className="text-[1rem] dark:text-[#D1D1D1]">
                {capitalize(lastRaceStatus)} Race
              </p>
          ...
          <div className="col-span-1 row-span-1 bg-[#e5f4ff] rounded-lg p-[1.5rem] flex flex-col gap-2 items-center justify-center text-center dark:bg-transparent dark:border dark:border-[#00387E] h-[10rem]">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Compete, earn, and grow in the world of stock predictions.
            </p>
            <button
              onClick={() => {
                // create Race
        ...
        <div className="col-span-1 row-span-1 bg-[#e5f4ff] rounded-lg p-[1.5rem] flex gap-8 dark:bg-transparent dark:border dark:border-[#00387E] items-start h-[10rem]">
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <p className="text-[2rem] dark:text-white font-poppins">
              {totalPoints}
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 row-span-1 bg-[#e5f4ff] rounded-lg p-[1.5rem] flex gap-8 dark:bg-transparent dark:border dark:border-[#00387E] items-start h-[10rem]">
          <div className="flex flex-col gap-[8px] dark:text-white">
            ...
            <p className="text-[2rem] font-bold font-poppins">
              {(winningRate.rate * 100).toFixed(2)}%
            </p>
      ...
      <div className="flex flex-col gap-2 mt-5 relative">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button
              className="rounded-full bg-[#e5f4ff] dark:bg-[#001B51] p-2 cursor-pointer"
              onClick={scrollLeft}
            >
        ...
        <div
          ref={sliderRef}
          className="flex gap-2 overflow-x-hidden flex-nowrap p-2 scroll-smooth w-full max-w-[81vw]"
        >
            ...
            <div className="rounded-lg p-3 w-full flex flex-col gap-5 mb-[8rem]">
              <div className="font-bold dark:text-slate-400 text-center">
                <div>
                  ...
                  monitor their trends effortlessly. Build your watchlist today.
                </div>
                <div className="font-extrabold text-2xl mt-3 dark:text-white">
                  Watch. Track. Grow.
                </div>
                ...
                <div
                  ...
                  className="border border-black dark:border-white px-3 py-2 cursor-pointer rounded-lg flex gap-2 items-center justify-center w-32 mx-auto mt-5"
                >
                  Add <FaPlus />
                </div>
              </div>
