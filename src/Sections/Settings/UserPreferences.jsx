...
const AlertRow = ({ label, enabled, onToggle }) => {
  return (
    <div className="dark:bg-[#002763] bg-[#e5f4ff] rounded-[15px] dark:border w-full dark:border-[#00387E] dark:text-white flex gap-[4rem] py-4 px-6">
      ...
      <div className="flex gap-2">
        ...
        >
          <span
            aria-hidden="true"
            className={`pointer-events-none inline-block size-5 -translate-x-1 rounded-full ${
              enabled ? "bg-white" : "dark:bg-[#001A50] bg-slate-300"
