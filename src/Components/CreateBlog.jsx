...
const CreateBlog = () => {
  ...
  //grabbing editor to intercept images
  ...
  const sumbitBlog = () => {
    if (!formData.bannerImg) {
      setError({
        show: true,
        message:
          "Featured image is required. Kindly add a featured image to be shown with your blog.",
      });
      return;
    }
    if (!formData.title || formData.title == "") {
      setError({
        show: true,
        message:
          "Title is required. Kindly add a title to be shown with your blog.",
      });
      return;
    }
        ...
        postBlog(
          ...
          (error) => {
            ...
            setError({
              show: true,
              message:
                "We have run into a backend issue. Kindly report it via Support from your profile.",
            });
          }
        );
      },
