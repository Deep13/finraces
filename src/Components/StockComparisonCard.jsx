...
const StockWatchlistCard = ({ data }) => {
    ...
    return (
        <div className='cursor-pointer w-[15rem] h-[10rem] min-w-[15rem] p-4 dark:text-white dark:bg-[#002763] rounded-xl shadow-lg dark:shadow-none border-[#00387E] flex flex-col gap-[9px] justify-between mr-3'>
