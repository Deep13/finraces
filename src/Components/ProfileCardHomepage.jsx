...
const ProfileCardHomepage = ({
    ...
    return (
        <div className='h-[332px] bg-white rounded-[18px] px-[13px] py-[0.5rem] flex flex-col dark:bg-[#002763]'>
            ...
            <div className='w-full flex gap-[8px] justify-start items-center mb-[10px]'>
                ...
                <p className='dark:text-white font-semibold'>@Aslace</p>
            </div>
            ...
            <div className='w-full flex justify-between'>
                <div className='flex-1 h-full'>
                    <p className={`${isFirst ? 'text-[#ff0000]' : 'text-black'} text-[12px] font-normal dark:text-white`}>Hippi Monster <span className='text-[15px] font-bold'>#1</span></p>
