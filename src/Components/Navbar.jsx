  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      if (
        ...
        event.target.id === "profileButtonP" ||
        event.target.id === "profileButtonD" ||
        event.target.id === "profileButtonI"
      ) {
        return;
      }
        ...
        <div className="flex gap-[12px] justify-start items-center">
          <div className="flex gap-2 items-center">
            <button
              ...
              onClick={toggle}
              className="aspect-square h-[2.35rem] grid place-items-center rounded-[8px]"
            >
              {!darkModeEnabled ? (
          ...
          {userDetails && (
            <button
              ...
              className="aspect-square dark:bg-[#001a50] h-[2.35rem] grid place-items-center rounded-[8px] dark:text-white"
            >
          ...
          {userDetails && (
            <div
              ...
              className={`aspect-square ${
                notificationToggle && "dark:bg-opacity-25"
              } dark:bg-[#001a50] h-[2.35rem] grid place-items-center rounded-[8px] relative cursor-pointer`}
            >
              <FaRegBell
                    ...
                    {unseenNotifications.slice(0, 5).map((notification) => {
                      return (
                        <div
                          ...
                          className="w-full cursor-pointer bg-slate-200 dark:bg-[#002763] py-2 px-4 rounded-lg"
                        >
          ...
          {userDetails && userDetailsObject && (
            <div
              ...
              className={`flex ${
                dropdown && "dark:bg-blue-900 bg-slate-300"
              } justify-center items-center gap-2 relative p-2 px-4 rounded-lg cursor-pointer`}
            >
              <p id="profileButtonP" className="dark:text-white">
                {userDetailsObject.userName}
              </p>
              <div
                id="profileButtonD"
                className="bg-white w-9 h-9 rounded-full overflow-hidden"
              >
                <img
                  id="profileButtonI"
                  ...
                  src={
                    profileImage ||
                    (userDetailsObject.gender &&
                    userDetailsObject.gender == "female"
                      ? femalePlaceholder
                      : malePlaceholder)
                  }
                  alt=""
                ...
                {dropdown && (
                  ...
                  >
                    <button
                      ...
                      className="w-full p-3 hover:bg-slate-200 transition-opacity duration-100 ease-linear text-start dark:text-white dark:hover:bg-opacity-20"
                    >
                      Profile
                    </button>
                    <p
                      onClick={() => navigate("/settings")}
                      className="w-full p-3 hover:bg-slate-200 transition-opacity duration-100 ease-linear dark:text-white dark:hover:bg-opacity-20"
                    >
                      Settings
                    </p>
                    <p
                    ...
                    <p
                      ...
                      className="w-full p-3 dark:font-semibold hover:bg-red-500 hover:text-white transition-opacity duration-100 ease-linear dark:text-white"
                    >
                      Log out
                    </p>
                  </motion.div>
          ...
          {guestDetails && userDetailsObject && (
            <div
              id="profileButton"
              onClick={(e) => {
                // set dropdown
