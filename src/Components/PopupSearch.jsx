...
const PopupSearch = ({ setPopupSearch }) => {
  ...
  const updateFilteredResults = useCallback(
    debounce(async (newQuery) => {
      // direcy callback instead of defining it ouside
                  ...
                  <div className="flex flex-wrap gap-4 justify-center">
                    {stockList.map((stock) => (
                      <div
                        ...
                        key={stock.id}
                        className="flex items-center justify-between dark:text-white cursor-pointer bg-slate-300 dark:bg-[#002763] rounded-xl w-full h-20 p-2"
                      >
