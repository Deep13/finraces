...
const StockWatchlistCard = () => {
    return (
        <div className='w-[13.2rem]  min-w-[13.2rem] p-4 dark:text-white dark:bg-[#002763] rounded-xl shadow-lg dark:shadow-none border-[#00387E] flex flex-col gap-[9px] justify-between mr-3'>
