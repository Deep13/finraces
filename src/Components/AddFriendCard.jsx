...
const AddFriendCard = () => {
    ...
    return (
        <div className='p-[10px] rounded-[20px] h-[4.2rem] w-[17.2rem] justify-between bg-slate-200 dark:bg-[#002763] flex shadow-lg dark:shadow-none items-center gap-[20px]'>
