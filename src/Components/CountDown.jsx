...
const CountDownTimer = ({ deadline, setIsTimerFinished, mode }) => {
  const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
      ...
      return (
        <div className="w-full flex justify-center items-center gap-[0.5rem] mb-2 text-[#2177cb] text-[2.1rem] font-poppins">
          <div className="w-full flex justify-center gap-2">
            ...
            <div className=" flex items-end pb-[4px]">:</div>
            <div className="flex flex-col">
              <p
                className={`text-center text-[0.7rem] ${
                  mode && mode == "Home"
  ...
  return <Countdown daysInHours={false} date={deadline} renderer={renderer} />;
};
