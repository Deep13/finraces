  ...
  return (
    <div className="w-full relative h-auto flex pb-8 pt-8 dark:bg-[#000924]">
      ...
      <div className="flex flex-col max-w-[70rem] gap-6 dark:bg-[#000D38] py-12 px-6 md:px-10 mx-auto flex-1 rounded-xl border dark:border-[#00387E] dark:text-white text-lg leading-8">
        <h1 className="text-4xl font-bold font-poppins mb-4">Privacy Policy</h1>

        <p className="text-lg">
          <strong>Last Updated:</strong> April 04, 2025
        </p>

        <p className="text-lg">
          At FinRacers (&#34;we,&#34; &#34;us,&#34; or &#34;our&#34;), we are
          committed to protecting your privacy. This Privacy Policy explains how
          we collect, use, disclose, and safeguard your personal information
          when you use our website, platform, and services (collectively, the
          "Service").
        </p>
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          <li>
            <strong>Account Registration:</strong> Name, email, password, and
            optionally phone number or social login info (Google/Facebook).
          </li>
          <li>
            <strong>User Content:</strong> Race predictions, messages, community
            posts, profile updates.
          </li>
          <li>
            <strong>Settings Preferences:</strong> Notification and privacy
            preferences, theme selections.
          </li>
          <li>
            <strong>Support Requests:</strong> Information submitted via support
            forms or emails.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          ...
          <li>
            <strong>Device & Log Data:</strong> IP, OS, browser, device,
            timestamps.
          </li>
          <li>
            <strong>Behavioral Data:</strong> Prediction patterns, accuracy,
            interactions.
          </li>
          <li>
            <strong>Geographic Data:</strong> Approximate location from IP or
            Google Analytics.
          </li>
          <li>
            <strong>Cookies & Tracking:</strong> Cookies and similar tools to
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          <li>
            Provide and improve the Service (races, leaderboards, community
            features).
          </li>
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          <li>
            <strong>We do not sell your personal info.</strong>
          </li>
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          <li>
            <strong>Encryption:</strong> AES-256 standard for sensitive data.
          </li>
          <li>
            <strong>2FA:</strong> Optional two-factor authentication via email.
          </li>
          <li>
            <strong>Monitoring:</strong> IP and device logs to detect suspicious
            activity.
          </li>
        </ul>
        <p className="text-lg">
          No system is 100% secure, but we strive to safeguard your data.
        </p>
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          ...
          <li>
            Request data access or deletion via{" "}
            <a
          ...
          <li>
            Delete your account via Settings (some data may be retained for
            compliance).
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside ml-4 text-lg">
          ...
          <li>
            Behavioral data may be anonymized and retained longer for analytics
            and cheating prevention.
          </li>
          <li>
            Deleted account data is purged within 30 days unless otherwise
            required.
          </li>
        </ul>
        ...
        <p className="text-lg">
          The Service is not intended for users under 18. If we learn that a
          child has submitted data, we will delete it immediately.
        </p>
        ...
        <p className="text-lg">
          ...
          (e.g., stock APIs, Google Analytics) linked or integrated within our
          platform.
        </p>
        ...
        <p className="text-lg">
          If you access our services internationally, your data may be processed
          in regions with different data laws. We ensure adequate protection and
          compliance.
        </p>
        ...
        <p className="text-lg">
          ...
          <br />
          📝 Help form is available in the &#34;Help and Support&#34; section of
          the Settings module.
        </p>
      </div>
    </div>
