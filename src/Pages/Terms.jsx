  ...
  return (
    <div className="w-full relative h-auto flex pb-8 pt-8 dark:bg-[#000924]">
      ...
      <div className="flex flex-col max-w-[70rem] gap-6 dark:bg-[#000D38] py-12 px-6 md:px-10 mx-auto flex-1 rounded-xl border dark:border-[#00387E] dark:text-white text-lg leading-8">
        ...
        <p>
          Welcome to FinRacers! These Terms and Conditions ("Terms") govern your
          access to and use of the FinRacers website, platform, and services
          (collectively, the "Service") provided by FinRacers ("we," "us," or
        ...
        <ul className="list-disc list-inside ml-4">
          <li>
            <strong>Account Creation:</strong> Register with a valid email or
            phone number and create a secure password. You may also use Google
            or Facebook to sign up.
          </li>
          <li>
            <strong>Account Responsibility:</strong> You are responsible for
            keeping your credentials secure. Contact{" "}
            <a
          ...
          <li>
            <strong>2FA:</strong> Optional or required two-factor authentication
            may be enforced for additional security.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            Not engage in cheating, manipulation, or disrupt fairness of races.
          </li>
          <li>Not upload or share illegal, harmful, or infringing content.</li>
        </ul>

        <h2 className="text-3xl font-bold mt-10 mb-2">
          4. Race Participation and Creation
        </h2>
        <ul className="list-disc list-inside ml-4">
          <li>
            <strong>Joining Races:</strong> Submit predictions before lock time
            (15 minutes prior to race start).
          </li>
          <li>
            <strong>Creating Races:</strong> Provide name, schedule, and stock
            list. Private races require invite links.
          </li>
          <li>
            <strong>Points and Rankings:</strong> Based on accuracy and
            volatility. Results are displayed publicly.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside ml-4">
          <li>
            All Service content and features are owned by FinRacers or its
            licensors.
          </li>
          <li>
            By submitting content, you grant FinRacers rights to use and display
            it for Service operations.
          </li>
        </ul>
        ...
        <p>
          ...
          <a href="/policy" className="text-blue-400 underline">
            Privacy Policy
          </a>
        ...
        <h2 className="text-3xl font-bold mt-10 mb-2">
          7. Market Research and Stock Data
        </h2>
        <ul className="list-disc list-inside ml-4">
          <li>
            Data is for informational and entertainment purposes only, not
            investment advice.
          </li>
        ...
        <ul className="list-disc list-inside ml-4">
          <li>
            <strong>By You:</strong> Delete your account anytime from Settings.
          </li>
          <li>
            <strong>By Us:</strong> We may suspend or terminate accounts for
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            We are not liable for losses related to race outcomes or stock data.
          </li>
        </ul>
        ...
        <p>
          To the fullest extent permitted by law, FinRacers and its affiliates
        ...
        <p>
          You agree to indemnify FinRacers against any losses or claims from
          your use of the Service or violations of these Terms.
        </p>
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            We may revise these Terms; continued use means acceptance of
            changes.
          </li>
        </ul>
