...
const AllRaces = () => {
  ...
  const [activeTab, setActiveTab] = useState(
    tabs[thisLocation?.state?.toString()]
  ); // Corrected default tab
    ...
    <>
      ...
      <div className="w-full relative h-auto flex pb-8 pt-8 dark:bg-[#000924] min-h-[100vh]">
        ...
        <div className="flex-1 flex flex-col items-center px-[2%] md:px-[6%]">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              >
                ...
                {stockSuggestions.length > 0 && (
                  <div className="notificationScrollbar dark:text-white flex flex-col gap-2 w-full md:w-60 max-h-48 p-2 overflow-y-auto rounded-xl dark:bg-[#000924] border-2 dark:border-[#00387E] absolute top-12 z-40">
          ...
          {activeTab === tabs["Ongoing Races"] && (
            <OngoingRacesAllRaces filters={filters} />
          )}
          {activeTab === tabs["Finished Races"] && (
            <FinishedRaces filters={filters} />
          )}
          {activeTab === tabs["Upcoming Races"] && (
            <UpcomingRacesAllRaces filters={filters} />
          )}
        </div>
      </div>
      <Footer />
