...
const Profile = () => {
  ...
  return (
    <>
      {NoUserPopup && (
        <NoProfilePopup
          setPopupVisible={setNoUserPopup}
        ...
        <div className="flex-1 px-[2%] md:px-[6%]">
          <div className="w-full rounded-xl bg-slate-200 p-4 flex flex-col gap-4 dark:bg-[#000D38]">
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <div className="flex-1 bg-white rounded-lg p-[1.5rem] flex justify-between dark:bg-[#001B51] dark:border dark:border-[#00387E]">
                <div className="flex flex-col md:flex-row justify-between w-full gap-6">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="font-semibold text-base -mt-2 text-slate-500 dark:text-white font-poppins">
                      {data?.email}
                    </p>
              ...
              <div className="flex flex-col gap-3">
                <button
                  onClick={() => setSuperTabs(superTabsStrings.Profile)}
                  className={
                ...
                <button
                  onClick={() => setSuperTabs(superTabsStrings.Interactions)}
                  className={
                    superTabs === superTabsStrings.Interactions
                      ? "w-[9rem] flex justify-center items-center py-[12.25px] bg-blue-600 text-white font-semibold rounded-[70px] text-[14px] dark:bg-gradient-to-r from-[#005BFF] to-[#5B89FF]"
                      : "w-[9rem] flex justify-center items-center py-[12.25px] border-[#00387e] border rounded-[70px] text-[14px] dark:border-[#00387E] dark:text-white"
                  }
                >
                ...
                <button
                  ...
                  className={
                    superTabs === superTabsStrings.EditProfile
                      ? "w-[9rem] flex justify-center items-center py-[12.25px] bg-blue-600 text-white font-semibold rounded-[70px] text-[14px] dark:bg-gradient-to-r from-[#005BFF] to-[#5B89FF]"
                      : "w-[9rem] flex justify-center items-center py-[12.25px] border-[#00387e] border rounded-[70px] text-[14px] dark:border-[#00387E] dark:text-white"
                  }
                >
                ...
                <button
                  ...
                  className="w-[9rem] flex justify-center items-center py-[12.25px] border-[#00387e] border rounded-[70px] text-[14px] dark:border-[#00387E] dark:text-white hover:bg-red-500 hover:text-white hover:border-red-500"
                >
                  Log out
                </button>
              </div>
