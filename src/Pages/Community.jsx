      ...
      <div className="flex flex-col w-[70rem] gap-4 bg-[#e5f4ff] dark:bg-[#000D38] py-6 md:px-10 mx-[1rem] md:mx-[7rem] flex-1 rounded-xl border dark:border-[#00387E] dark:text-white">
        ...
        <div className="flex items-start justify-center m-2 w-full gap-5">
          <div className="flex-1 flex flex-col gap-5 px-2">
            {/* Post Creation Box */}
            <div className="dark:bg-[#002763] rounded-xl flex gap-4 p-5 w-full">
              {/* User Avatar */}
              ...
              <div className="flex flex-col gap-3 flex-1">
                <input className="rounded-xl px-4 py-3 bg-[#001B51] text-white placeholder-gray-400 focus:outline-none" placeholder="Start a post..." />
                <div className="flex items-center justify-evenly text-white">
                  <button className="hover:text-gray-300 transition-all flex items-center gap-1"><BiMedal size={24}/> Media</button>
            ...
            <div className="sticky top-0 z-10 flex items-center justify-center gap-2 w-full p-3 rounded-xl dark:bg-[#002763]">
              {tabs.map((tab, index) => (
                <button
                  key={index}
                  className={`px-5 py-2 rounded-full text-white font-semibold transition-all ${
                    activeTab === tab
                      ? "bg-[#00387E] shadow-md"
                      : "bg-[#001B51] hover:bg-[#002763]"
                  }`}
          ...
          <div className="w-96 flex flex-col items-center justify-center gap-5">
            ...
            {/* Top Leaders Section */}
            <div className="dark:bg-[#002763] p-4 rounded-xl w-full text-white min-h-[25rem] max-h-[30rem] overflow-y-auto flex flex-col gap-4">
                ...
                {topLeaders.map((leader) => (
                  <div key={leader.id} className="flex items-center justify-between p-3 border border-[#00387E] w-full rounded-xl h-20 bg-[#001B51]">
                    ...
                    <button className="p-2 rounded-full hover:bg-[#00387E] transition">
                      <FaRegCommentAlt size={22} className="text-white"/>
                    </button>
                  </div>
                ))}
              </div>
              ...
              <div className="flex-1 flex flex-col gap-3">
                {topStocks.map((stock) => (
                  <div key={stock.id} className="flex items-center justify-between p-3 border border-[#00387E] w-full rounded-xl h-20 bg-[#001B51]">
                    ...
                    {/* Arrow Icon */}
                    <button className="p-2 rounded-full hover:bg-[#00387E] transition">
                      <MdKeyboardArrowRight size={32} className="text-white"/>
                    </button>
                  </div>
                ))}
              </div>
