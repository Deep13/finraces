    ...
    Promise.all(allPromises)
      .then((results) => {
        ...
        results.forEach((stockData, index) => {
          ...
          let stockPrices = stockData.data.results.map(
            (entry) => entry[typeMap[years]]
          ); // Closing prices
        ...
        getStockComparisonData(
          ...
          (data) => {
            ...
            setIncomeTableData((prevData) => {
              ...
              updatedData[0] = {
                ...updatedData[0],
                values: [...updatedData[0].values],
              };
              updatedData[0].values[i] =
                data?.financials?.income_statement?.revenues?.value ?? "--";

              updatedData[1] = {
                ...updatedData[1],
                values: [...updatedData[1].values],
              };
              updatedData[1].values[i] =
                data?.financials?.income_statement?.operating_expenses?.value ??
                "--";

              updatedData[2] = {
                ...updatedData[2],
                values: [...updatedData[2].values],
              };
              updatedData[2].values[i] =
                data?.financials?.income_statement?.operating_income_loss
                  ?.value ?? "--";

              updatedData[3] = {
                ...updatedData[3],
                values: [...updatedData[3].values],
              };
              updatedData[3].values[i] =
                data?.financials?.income_statement?.research_and_development
                  ?.value ?? "--";
            ...
            setTableData((prevData) => {
              ...
              updatedData[0].values[i] =
                data?.financials?.income_statement?.basic_average_shares
                  ?.value ?? "--";
              ...
              updatedData[1].values[i] =
                data?.financials?.income_statement?.basic_earnings_per_share
                  ?.value ?? "--";
              ...
              updatedData[3].values[i] =
                data?.financials?.income_statement?.diluted_earnings_per_share
                  ?.value ?? "--";

              updatedData[4] = {
                ...updatedData[4],
                values: [...updatedData[4].values],
              };
              updatedData[4].values[i] =
                data?.financials?.income_statement?.diluted_earnings_per_share
                  ?.value ?? "--";

              updatedData[5] = {
                ...updatedData[5],
                values: [...updatedData[5].values],
              };
              updatedData[5].values[i] =
                data?.financials?.comprehensive_income
                  ?.comprehensive_income_loss?.value ?? "--";
            ...
            setSheetTableData((prevData) => {
              ...
              updatedData[0].values[i] =
                data?.financials?.balance_sheet?.assets?.value ?? "--";
              ...
              updatedData[1].values[i] =
                data?.financials?.balance_sheet?.equity?.value ?? "--";
              ...
              updatedData[2].values[i] =
                data?.financials?.balance_sheet?.inventory?.value ?? "--";
              ...
              updatedData[3].values[i] =
                data?.financials?.balance_sheet?.liabilities?.value ?? "--";
              ...
              updatedData[4].values[i] =
                data?.financials?.balance_sheet.long_term_debt?.value ?? "--";
            ...
            setCashTableData((prevData) => {
              ...
              updatedData[0].values[i] =
                data?.financials?.cash_flow_statement?.net_cash_flow?.value ??
                "--";
  ...
  return (
    <div className="w-full relative h-auto flex pb-8 pt-8 dark:bg-[#000924]">
      ...
      <div className="dark:bg-[#000D38] py-5 md:px-10 mx-[1rem] md:mx-[7rem] flex flex-1 flex-col rounded-xl border dark:border-[#00387E] dark:text-white">
        ...
        <div className=" bg-[#e4eaf0] dark:bg-[#001a50] flex rounded-xl py-2 px-2 mb-7">
          {/* <div className="w-[10%]">
        ...
        <div className="h-[3rem] z-10 top-20 sticky border-2 dark:border-0 dark:bg-[#001a50] grid grid-cols-5 rounded-xl py-2 px-5 mb-7 font-poppins font-semibold">
          ...
          {selectedStocks.map((stock, index) => (
            <div
              key={index}
              className="flex justify-center items-center col-span-1 gap-2"
            >
        ...
        <div className="h-auto dark:bg-[#001a50] dark:border-0 border-2 rounded-xl py-2 px-5 mb-7">
          {tableData.map((row, rowIndex) => (
            <div
              key={rowIndex}
              className="grid grid-cols-5 gap-4  dark:text-slate-200 py-2"
            >
        ...
        <div className="h-auto dark:bg-[#001a50] dark:border-0 border-2 rounded-xl py-2 px-5 mb-7">
          <div className="font-semibold text-[1.5rem] font-poppins my-5">
            Balance Sheet
          </div>
                    ...
                    {stocksData
                      ...
                      .map((data) => (
                        <div
                          ...
                          className="dark:bg-[#001a50] rounded-lg p-2 cursor-pointer"
                          key={data.id}
                        >
